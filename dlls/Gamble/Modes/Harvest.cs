...
namespace PoE.dlls.Gamble.Modes
{
    public class Harvest : IGamba
    {
        ...
        public Harvest(Main main, Simulator simulator, CancellationTokenSource cts, TimeSpan delay, double speed, Coordinates item, Coordinates button, List<Rule> rules)
        {
            _main = main;
