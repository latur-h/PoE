...
namespace PoE.dlls.Gamble.Modes
{
    public class Alt : IGamba
    {
        ...
        public Alt(Main main, InputSimulatorHost inputHost, CancellationTokenSource cts, TimeSpan delay, double speed, Coordinates item, Coordinates orb, List<Rule> rules)
        {
            _main = main;
